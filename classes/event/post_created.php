...
/**
 * The mod_anonforum post created event.
 *
...
/**
 * The mod_anonforum post created event class.
 *
 * @property-read array $other {
 *      Extra information about the event.
 *
 *      - int discussionid: The discussion id the post is part of.
 *      - int anonforumid: The forum id the post is part of.
 *      - string anonforumtype: The type of forum the post is part of.
 * }
 *
 * @since      Moodle 2.8
 * @package    mod_anonforum
...
class post_created extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('eventpostcreated', 'mod_anonforum');
    }
