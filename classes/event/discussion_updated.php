...
/**
 * The mod_anonforum discussion updated event.
 *
...
/**
 * The mod_anonforum discussion updated event class.
 *
...
class discussion_updated extends \core\event\base {
    ...
    public function get_description() {
        return "The user with id '$this->userid' has updated the discussion with id '$this->objectid' in the anonforum " .
    ...
    public static function get_name() {
        return get_string('eventdiscussionupdated', 'mod_anonforum');
    }
