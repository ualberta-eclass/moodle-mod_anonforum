...
/**
 * The mod_anonforum course searched event.
 *
...
/**
 * The mod_anonforum course searched event class.
 *
...
class course_searched extends \core\event\base {
    ...
    public function get_description() {
        ...
        return "The user with id '$this->userid' has searched the course with id '$this->courseid' for anonforum posts " .
    ...
    public static function get_name() {
        return get_string('eventcoursesearched', 'mod_anonforum');
    }
    ...
    public function get_url() {
        return new \moodle_url('/mod/anonforum/search.php',
