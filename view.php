...
switch ($anonforum->type) {
    ...
    case 'eachuser':
        ...
        if (!empty($showall)) {
            ...
            anonforum_print_latest_discussions($course, $anonforum, -1, 'header', '', -1, -1, $page,
                $CFG->anonforum_manydiscussions, $cm);
        }
        break;
    ...
    case 'blog':
        ...
        if (!empty($showall)) {
            ...
            anonforum_print_latest_discussions($course, $anonforum, -1, 'plain', '', -1, -1, $page,
                $CFG->anonforum_manydiscussions, $cm);
        }
        break;
