...
Feature: A teacher can set one of 3 possible options for tracking read anonymous forum posts
  ...
  @javascript
  Scenario: Tracking anonymous forum posts forced with user tracking on
  ...
  @javascript
  Scenario: Tracking anonymous forum posts forced with user tracking off
    Given I set the following administration settings values:
      | Allow forced read tracking | 1 |
    And I follow "Home"
    And I follow "Course 1"
  ...
  @javascript
  Scenario: Tracking anonymous forum posts forced (with force disabled) with user tracking on
    Given I set the following administration settings values:
      | Allow forced read tracking | 1 |
    And I follow "Home"
    And I follow "Course 1"
  ...
  @javascript
  Scenario: Tracking anonymous forum posts forced (with force disabled) with user tracking off
    Given I set the following administration settings values:
      | Allow forced read tracking | 1 |
    And I follow "Home"
    And I follow "Course 1"
